...
class SaleItemTable {
  ...
  static const enteredAmount = 'enteredAmount';
  static const calculatedQuantity = 'calculatedQuantity';
  ...
  static const createTable =
    ...
    CREATE TABLE IF NOT EXISTS $tableName (
      ...
      $enteredAmount REAL NOT NULL DEFAULT 0,
      $calculatedQuantity REAL NOT NULL DEFAULT 0,
